...
class com.joangarnet.containers.SplitPane extends UIComponent
{
	 ...
	 * 
	 * ReadOnly constant that contains the value to assign SplitPane's horizontal orientation. The numeric value is 1.
	 * 
	 * See also:
	 * 
	 ...
	 * 
	 * ReadOnly constant that contains the value to assign SplitPane's vertical orientation. The numeric value is 2.
	 * 
	 * See also:
	 * 
	 ...
	 * 
	 * Getter/setter. The orientation property determines if the SplitPane instance 
	 * is divided either vertically or horizontally.
	 * (start code)
	 ...
	 * Parameters:
	 * 
	 * 	_orientation - It can be either a String or a Number. 
	 * 				Valid values are "HORIZONTAL_SPLIT" or SplitPane.HORIZONTAL_SPLIT, "VERTICAL_SPLIT" or SplitPane.VERTICAL_SPLIT.
	 * 
	 * Returns:
	 * 
	 * 	A Number. Either 1 (SplitPane.HORIZONTAL_SPLIT) or 2 (SplitPane.VERTICAL_SPLIT).
	 * 
	 * See Also:
	 * 
	 ...
	 * 
	 * Getter/setter. The oneTouchExpandable property determines if the SplitPane divider 
	 * has a control to expand / contract and, when set, it also executes the expand / contract action.
	 * 
	 * Parameters:
	 * 
	 * 	_oneTouchExpandable - A boolean value.
	 * 
	 * Returns:
	 * 
	 * 	A Boolean.
	 ...
	 * 
	 * Getter/setter. The expansionDirection property determines the expansion direction when the divider control is 
	 * expanded / contracted.
	 * 
	 * Parameters:
	 * 
	 * 	_expansionDirection - A String indicating the divider expansion direction.
	 * 				Valid values are "rightLeft", "bottomTop", "leftRight", "topBottom"
	 * 
	 * Returns:
	 * 
	 * 	A String.
	 ...
	 * 
	 * Getter/setter. The size in pixels of the divider assets. 
	 * 
	 * Parameters:
	 * 
	 * 	size - A Number indicating the divider asets size
	 * 
	 * Returns:
	 * 
	 * 	A Number.
	 ...
	 * 
	 * Getter/setter. The divider location in %.
	 * (start code)
	 ...
	 * Parameters:
	 * 
	 * 	percent - A Number indicating the divider location in % (left to right, top to bottom)
	 * 
	 * Returns:
	 * 
	 * 	A Number indicating the current divider location in %.
	 */
	 ...
	 * 
	 * Getter/setter. The minimum value in % where the divider can be dragged.
	 * 
	 * Parameters:
	 * 
	 * 	percent - A Number indicating the divider minimum location in % (left to right, top to bottom).
	 * 
	 * Returns:
	 * 
	 * 	A Number indicating the minimum divider location in %.
	 */	
	 ...
	 * 
	 * Getter/setter. The maximum value in % where the divider can be dragged.
	 * 
	 * Parameters:
	 * 
	 * 	percent - A Number indicating the divider maximum location in % (left to right, top to bottom).
	 * 
	 * Returns:
	 * 
	 * 	A Number indicating the maximum divider location in %.
	 */		
	 ...
	 * 
	 * Getter/setter. Sets the expanded state to contracted (false) or expanded (true). When this property 
	 * changes, a *paneExpanded* event is thrown.
	 * 
	 * Parameters:
	 * 
	 * 	expanded - A Boolean.
	 ...
	 * 
	 * Getter. The last position in % where the divider was located right before the current position.
	 * 
	 * Returns:
	 * 
	 * 	A Number.
	 ...
	 * 
	 * Getter. A reference to the SplitPane's top component
	 * 
	 * Returns:
	 * 
	 * 	Either a ScrollPane or a SplitPane instance
	 */
	 ...
	 * 
	 * Getter. A reference to the SplitPane's left component
	 * 
	 * Returns:
	 * 
	 * 	Either a ScrollPane or a SplitPane instance
	 ...
	 * 
	 * Getter. A reference to the SplitPane's bottom component
	 * 
	 * Returns:
	 * 
	 * 	Either a ScrollPane or a SplitPane instance
	 ...
	 * 
	 * Getter. A reference to the SplitPane's right component
	 * 
	 * Returns:
	 * 
	 * 	Either a ScrollPane or a SplitPane instance
	 ...
	 * Resets maximumDividerLocation, minimumDividerLocation, dividerLocation and sets dividerExpanded to true.
	 */
	...
	/*
	 * Function: nestLeft
	 * Nest a SplitPane instance inside the current SplitPane's leftPane.
	 */
	...
	/*
	 * Function: nestTop
	 * Nest a SplitPane instance inside the current SplitPane's topPane.
	 */
	...
	/*
	 * Function: nestRight
	 * Nest a SplitPane instance inside the current SplitPane's rightPane.
	 */
	...
	/*
	 * Function: nestBottom
	 * Nest a SplitPane instance inside the current SplitPane's bottomPane.
	 */
