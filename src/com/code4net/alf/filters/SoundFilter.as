...
class com.code4net.alf.filters.SoundFilter implements IFilter {
	private static var FILTER_NAME:String = "SoundFilter";
	
	public function execute(item : Array) : Boolean {
		return item[ItemHelper.ITEM_TYPE] == ItemHelper.SOUND;
	}
