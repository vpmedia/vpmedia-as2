...
class com.code4net.alf.filters.CompiledFilter implements IFilter {
	private static var FILTER_NAME:String = "ComipledFilter";
	
	public function execute(item : Array) : Boolean {
		return item[ItemHelper.ITEM_TYPE] == ItemHelper.COMPILED_CLIP;
	}
