...
class com.code4net.alf.filters.MCFilter implements IFilter{
	private static var FILTER_NAME:String = "MCFilter";
	
	public function execute(item:Array):Boolean {
		return item[ItemHelper.ITEM_TYPE] == ItemHelper.MOVIE_CLIP;
	}
