...
class com.code4net.alf.filters.BitmapFilter implements IFilter {
	private var FILTER_NAME:String = "BitmapFilter";
	
	public function execute(item : Array) : Boolean {
		return item[ItemHelper.ITEM_TYPE] == ItemHelper.BITMAP;
	}
