...
class com.code4net.alf.filters.ScreenFilter implements IFilter {
	private var FILTER_NAME:String = "ScreenFilter";
	
	public function execute(item : Array) : Boolean {
		return item[ItemHelper.ITEM_TYPE] == ItemHelper.SCREEN;
	}
