...
class com.code4net.alf.filters.FontFilter implements IFilter {
	public static var FILTER_NAME:String = "FontFilter";
	
	public function execute(item : Array) : Boolean {
		return item[ItemHelper.ITEM_TYPE] == ItemHelper.FONT;
	}
