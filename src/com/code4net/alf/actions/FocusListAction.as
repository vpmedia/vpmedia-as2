...
class com.code4net.alf.actions.FocusListAction implements ICommand {
	private var focusManager:FocusManager;
	
	public function FocusListAction() {
		focusManager = _root.focusManager;	
	}
	
	public function execute(params:Object) {
		var currentScreen:IResultView = IResultView(FlashLibrary.getInstance().currentResultsView);
		currentScreen.focusResultList();
	}
}