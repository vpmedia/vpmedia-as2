...
class com.code4net.alf.actions.SelectInLibraryAction implements ICommand {
	public function execute(params:Object) {
		...
		if (selectedItem[ItemHelper.ITEM_TYPE] != "screen") {
			XMLUI.set("selectedItem",selectedItem[ItemHelper.NAME]);
			XMLUI.set("selectInLibrary","true");
//			XMLUI.accept();
		}
	}
}