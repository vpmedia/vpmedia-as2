...
class com.asual.swfaddress.SWFAddress {
    ...
    private static function _indexOf(obj:Object, arr:Array):Number {
    ...
    public static function getAutoUpdate():Boolean {
        ...
        if (_availability)
            autoUpdate = String(ExternalInterface.call('SWFAddress.getAutoUpdate'));
        return (autoUpdate == 'null' || autoUpdate == 'undefined') ? _autoUpdate : (autoUpdate == 'true');
    }
    ...
    public static function setValue(value:String):Void {
        ...
        if (SWFAddress._value == value && !_updating) return;
        SWFAddress._value = value;
    ...
    public static function setParameter(name:String, value:Object, append:Boolean):Void {
