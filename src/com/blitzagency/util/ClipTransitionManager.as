...
//constructor: 
	public function ClipTransitionManager(p_startingClip) 
	{
		if(debug) _global.tt("ClipTransitionManager instantiated", p_startingClip);
		// constructor
...
// methods:
	...
	*/
	function onTransitionInComplete():Void 
	{
		...
		// dispatchEvent
		dispatchEvent({type:"ClipTransitionManager - onTransitionInComplete", currentClip:currentClip})
	}
