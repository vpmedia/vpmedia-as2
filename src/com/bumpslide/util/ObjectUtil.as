 ...
 * 
 * David stole this from AS2LIB, and removed all the dependencies and crap.
 * 
 * @author Simon Wacker
...
class com.bumpslide.util.ObjectUtil {
	...
	private static function compareRecursive(obj1, obj2, stack1:Array, stack2:Array):Boolean {
		...
		if (typeof obj1 == "object"
			...
			// DK added length check for arrays
			if(obj1 instanceof Array && obj1.length!=obj2.length) return false;
			...
			if (obj1.__proto__ == obj2.__proto__) {
				...
				stack1.pop();
				stack2.pop();
				//Debug.info("recusively ==");
				return true;
			} else {
				return false;
			}
		} else {
			//Debug.info( (obj1 == obj2) ? "==" : "!=");
			return (obj1 == obj2);
		}
	}	
	
	static function clone(obj:Object) {
		if(ObjectUtil.isPrimitiveType(obj) || obj==null || obj==undefined) return obj;
		return com.bumpslide.util.ArrayUtil.dCopy( obj );
	}
	...
	/**
	 * static method called from within __KEY getter in objects
	 * 
	 * no need to ever call this directly. please ignore.
	 * 
	 */
	public static function getNextHashKey() : Number 
	{
		return ObjectUtil._nKEY++;
	}
	
		// Private Hash Key Stuff Below...
	private static var _nKEY:Number = 0;
	private static var _bINIT : Boolean = ObjectUtil.initHashKeys( Object.prototype );
	
	
	public static function initHashKeys(o) : Boolean
	{
		o.__nKEY = null;
		o.__getKEY = function () 
		{
			...
			if (this.__nKEY == null) 
			{
				this.__nKEY = ObjectUtil.getNextHashKey();
