 ...
 * 
 * This script is not a part of the Bumpslide Library and was not written by David Knape. 
 * It is here so for use with the SWFAddressTracker class.  
 * Luckily we share the same MIT License
 */

import flash.external.*;

class com.bumpslide.data.SWFAddress {
