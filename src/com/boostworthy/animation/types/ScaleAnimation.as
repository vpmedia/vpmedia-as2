...
class com.boostworthy.animation.types.ScaleAnimation extends Animation
{
	// =====================================================================================
	// CLASS DECLERATIONS
	// =====================================================================================
	...
	public function ScaleAnimation(mcScope:MovieClip, nTargetValueX:Number, nTargetValueY:Number, nDuration:Number, strTransition:String)
	{
		...
		m_nStartValue_X  = m_objScope._xscale;
		m_nStartValue_Y  = m_objScope._yscale;
	...
	public function Update():Boolean
	{
		...
		if(nTime < m_nDuration)
		{
			...
			m_objScope._xscale = m_fncTransition(nTime, m_nStartValue_X, m_nChangeValue_X, m_nDuration);
			m_objScope._yscale = m_fncTransition(nTime, m_nStartValue_Y, m_nChangeValue_Y, m_nDuration);
		...
		else
		{
			...
			m_objScope._xscale = m_nTargetValue_X;
			m_objScope._yscale = m_nTargetValue_Y;
