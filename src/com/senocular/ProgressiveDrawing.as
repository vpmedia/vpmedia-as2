...
*
* @usage
* <pre><code>import com.senocular.ProgressiveDrawing;
...
class com.senocular.ProgressiveDrawing {
	...
	*/
	function ProgressiveDrawing(target:MovieClip) {
	...
	*/
	public function draw(frames:Number, target:MovieClip):ProgressiveDrawing {
	...
	* @see clear
	*/
	public function clearDrawing(suppressClear:Boolean):ProgressiveDrawing {
		this.pen = {x:0, y:0};
		this._penTo = {x:0, y:0};
	...
	* @see draw
	*/
	public function setEase(easeMethod:Function, args):ProgressiveDrawing {
	...
	* @return The ProgressiveDrawing instance calling the method.
	* @see appendDrawing
	* @see prependDrawing
	*/
	public function setDrawing(drawing:ProgressiveDrawing):ProgressiveDrawing {
	...
	* @see prependDrawing
	*/
	public function appendDrawing(drawing:ProgressiveDrawing):ProgressiveDrawing {
	...
	* @see appendDrawing
	*/
	public function prependDrawing(drawing:ProgressiveDrawing):ProgressiveDrawing {
	...
	* @see moveTo
	*/
	public function startAt(sx:Number, sy:Number):ProgressiveDrawing {
	...
	* @see curveTo
	*/
	public function curveMoveTo(cx:Number, cy:Number, ex:Number, ey:Number):ProgressiveDrawing {
	...
	* @see moveCurveTo
	*/
	public function pauseFor(t:Number):ProgressiveDrawing {
	...
	* @see endFill
	*/
	public function lineStyle(thick:Number, col:Number, alpha:Number):ProgressiveDrawing {
	...
	* @see endFill
	*/
	public function beginFill(col:Number, alpha:Number):ProgressiveDrawing {
	...
	* @see curveTo
	*/
	public function beginGradientFill(fillType:String, colors:Array, alphas:Array, ratios:Array, matrix:Object):ProgressiveDrawing {
	...
	* @see curveTo
	*/
	public function moveTo(ex:Number, ey:Number):ProgressiveDrawing {
	...
	* @see curveTo
	*/
	public function lineTo(ex:Number, ey:Number):ProgressiveDrawing {
	...
	* @see lineTo
	*/
	public function curveTo(cx:Number, cy:Number, ex:Number, ey:Number):ProgressiveDrawing {
	...
	* @see beginGradientFill
	*/
	public function endFill(col:Number, alpha:Number):ProgressiveDrawing {
	...
	* @see lineTo
	*/
	public function clear(Void):ProgressiveDrawing {
