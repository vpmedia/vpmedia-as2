/**
 * Hungary Map Class 2006. András Csizmadia 
 * 
...
import mx.utils.events.Delegate;
// Define Class
class com.vpmedia.HungaryMap extends MovieClip
{
	// START CLASS
	...
	public static var county_array:Array = new Array (
		{idx:1, instance:"megye_budapest", label:"Budapest", city:"Budapest", color:0xFFE4BF},
		{idx:2, instance:"megye_baranya", label:"Baranya", city:"Pécs", color:0xFFF4E6},
		{idx:3, instance:"megye_bacs", label:"Bács-Kiskun", city:"Kecskemét", color:0xD9BFFF},
		{idx:4, instance:"megye_bekes", label:"Békés", city:"Békéscsaba", color:0xB280FF},
		{idx:5, instance:"megye_borsod", label:"Borsod-Abaúj-Zemplén", city:"Miskolc", color:0xFFFCE6},
		{idx:6, instance:"megye_csongrad", label:"Csongrád", city:"Szeged", color:0xF0E6FF},	
		{idx:7, instance:"megye_fejer", label:"Fejér", city:"Székesfehérvár", color:0xBFD4FF},
		{idx:8, instance:"megye_gyor", label:"Győr-Moson-Sopron", city:"Győr", color:0x607FBF},
		{idx:9, instance:"megye_hajdu", label:"Hajdú-Bihar", city:"Debrecen", color:0xFFEF80},
		{idx:10, instance:"megye_heves", label:"Heves", city:"Eger", color:0xFFF7BF},
		{idx:11, instance:"megye_komarom", label:"Komárom-Esztergom", city:"Tatabánya", color:0x80AAFF},
		{idx:12, instance:"megye_nograd", label:"Nógrád", city:"Salgótarján", color:0xBFB360},
		{idx:13, instance:"megye_pest", label:"Pest", city:"Budapest", color:0xBF9660},			
		{idx:14, instance:"megye_somogy", label:"Somogy", city:"Kaposvár", color:0xFFBFD4},				
		{idx:15, instance:"megye_szabolcs", label:"Szabolcs-Szatmár-Bereg", city:"Nyíregyháza", color:0xC9FFBF},
		{idx:16, instance:"megye_jasz", label:"Jász-Nagykun-Szolnok", city:"Szolnok", color:0x8660BF},			
		{idx:17, instance:"megye_tolna", label:"Tolna", city:"Szekszárd", color:0xFFC980},		
		{idx:18, instance:"megye_vas", label:"Vas", city:"Szombathely", color:0xE6EEFF},		
		{idx:19, instance:"megye_veszprem", label:"Veszprém", city:"Veszprém", color:0xFFDBBF},
		{idx:20, instance:"megye_zala", label:"Zala", city:"Zalaegerszeg", color:0xBFF7FF}
	);
	public static var region_array:Array = new Array (		
		{idx:1, instance:"region_nyugat-dunantul", content:"Győr-Moson-Sopron,Vas,Zala", label:"Nyugat-Dunántúl", color: 0xFAD9F2},
		{idx:2, instance:"region_kozep-dunantul", content:"Fejér,Komárom-Esztergom,Veszprém", label:"Közép-Dunántúl", color: 0xB0C5F0},
		{idx:3, instance:"region_del-dunantul", content:"Baranya,Somogy,Tolna", label:"Dél-Dunántúl", color: 0xFAE6D4},
		{idx:4, instance:"region_kozep-magyarorszag", content:"Budapest,Pest", label:"Közép-Magyarország", color: 0xEDD3BB},
		{idx:5, instance:"region_eszak-magyarorszag", content:"Borsod-Abaúj-Zemplén,Heves,Nógrád", label:"Észak-Magyarország", color: 0xE6EDBB},
		{idx:6, instance:"region_eszak-alfold", content:"Hajdú-Bihar,Jász-Nagykun-Szolnok,Szabolcs-Szatmár-Bereg", label:"Észak-Alföld", color: 0xB0EDBB},
		{idx:7, instance:"region_del-alfold", content:"Bács-Kiskun,Békés,Csongrád", label:"Dél-Alföld", color: 0xD6DEF0}
	);
