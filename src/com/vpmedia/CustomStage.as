...
// Start
class com.vpmedia.CustomStage extends MovieClip implements IFramework
{
	// START CLASS
	/**
	 ...
	 * @version 1.0
	 */
	public var className:String = "CustomStage";
	...
	{
		com.vpmedia.CustomStage.centerOnStageX (__mc);
		com.vpmedia.CustomStage.centerOnStageY (__mc);
	}
	...
	{
		com.vpmedia.CustomStage.L_OnStage (__mc);
		com.vpmedia.CustomStage.B_OnStage (__mc);
	}
	public static function RB_OnStage (__mc:MovieClip):Void
	{
		com.vpmedia.CustomStage.R_OnStage (__mc);
		com.vpmedia.CustomStage.B_OnStage (__mc);
	}
	public static function TL_OnStage (__mc:MovieClip):Void
	{
		com.vpmedia.CustomStage.T_OnStage (__mc);
		com.vpmedia.CustomStage.L_OnStage (__mc);
	}
	...
	{
		com.vpmedia.CustomStage.setStageWidth (__mc);
		com.vpmedia.CustomStage.setStageHeight (__mc);
	}
	/**
