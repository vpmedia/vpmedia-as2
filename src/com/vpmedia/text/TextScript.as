...
class com.vpmedia.text.TextScript {
	...
	public static function zoomIn (scope:MovieClip, phrase:String, x:Number, y:Number, format:TextFormat, delay:Number, paraWidth:Number, lineHeight:Number):MovieClip {
		return createEffect (scope, phrase, x, y, format, delay, paraWidth, lineHeight, TextScript.getInstance ().zoomInTransition);
	}
	...
	public static function zoomOut (scope:MovieClip, phrase:String, x:Number, y:Number, format:TextFormat, delay:Number, paraWidth:Number, lineHeight:Number):MovieClip {
		return createEffect (scope, phrase, x, y, format, delay, paraWidth, lineHeight, TextScript.getInstance ().zoomOutTransition);
	}
	...
	public static function blurIn (scope:MovieClip, phrase:String, x:Number, y:Number, format:TextFormat, delay:Number, paraWidth:Number, lineHeight:Number):MovieClip {
		return createEffect (scope, phrase, x, y, format, delay, paraWidth, lineHeight, TextScript.getInstance ().blurInTransition);
	}
	...
	public static function dropIn (scope:MovieClip, phrase:String, x:Number, y:Number, format:TextFormat, delay:Number, paraWidth:Number, lineHeight:Number):MovieClip {
		return createEffect (scope, phrase, x, y, format, delay, paraWidth, lineHeight, TextScript.getInstance ().dropInTransition);
	}
	...
	public static function randomDropIn (scope:MovieClip, phrase:String, x:Number, y:Number, format:TextFormat, delay:Number, paraWidth:Number, lineHeight:Number):MovieClip {
		return createEffect (scope, phrase, x, y, format, delay, paraWidth, lineHeight, TextScript.getInstance ().randomDropInTransition);
	}
