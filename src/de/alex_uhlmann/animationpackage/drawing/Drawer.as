...
* @author Alex Uhlmann
* @description
* 			The Drawer class allows to draw and animate arbitrary shapes/lines and treat 
* 			the outline and fill seperatly.
* 			Drawer uses the composite design pattern. [GoF]
* 			<p>
* 			Example 1: <a href="Drawer_01.html">(Example .swf)</a> Drawing a filled shape.
* 			<blockquote><pre>
...
*			</pre></blockquote>
* 			<p>
* 			Example 2: <a href="Drawer_02.html">(Example .swf)</a> Animating a filled shape.
* 			<blockquote><pre>
	...
	*/	
	public function fill(Void):Void {
		...
		*/
		...
		var lastChild:Object = firstChild;
		...
		for (i = 0; i < len; i++) {
			...
			//the fill doesn't need an outline.
			child.lineStyle();			
