...
class de.popforge.engine.w3d.ZLighten
implements Renderer
{
	...
	public function ZLighten( clip: MovieClip )
	{
		g = clip;
		g.blendMode = 'layer';
	...
	public function renderTriPoly( triPoly: TriPoly, p: Projection ): Void
	{
		...
		//-- create clip for each polygon
		var g: MovieClip = this.g.createEmptyMovieClip( pNum.toString(), pNum++ );
		g.blendMode = 'lighten';
