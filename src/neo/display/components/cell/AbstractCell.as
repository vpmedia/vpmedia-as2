...
import neo.display.components.button.AbstractIconButton;
...
class neo.display.components.cell.AbstractCell extends AbstractIconButton implements ICell {
	...
	static private var __CELL_INDEX__:Boolean = PropertyFactory.create(AbstractCell, "cellIndex", true) ;
	static private var __LIST_OWNER__:Boolean = PropertyFactory.create(AbstractCell, "listOwner", true) ;
