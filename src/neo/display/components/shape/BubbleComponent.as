...
class neo.display.components.shape.BubbleComponent extends AbstractComponent {
	...
	static public var BOTTOM_LEFT:Number = Align.BOTTOM_LEFT ;
	static public var BOTTOM_RIGHT:Number = Align.BOTTOM_RIGHT;
	...
	static public var TOP_LEFT:Number = Align.TOP_LEFT ;
	static public var TOP_RIGHT:Number = Align.TOP_RIGHT;
	...
	public function setAlign( align ) : Void {
		if (TypeUtil.typesMatch(align, Number)) {
			_align = align ;
			break ;
		} else if (TypeUtil.typesMatch(align, String)) {
			_align = Align.toNumber(align) ;
		}
		update() ;
	}
	...
	static private var __ALIGN__:Boolean = PropertyFactory.create(BubbleComponent, "align", true) ;
	static private var __ARROW_HEIGHT__:Boolean = PropertyFactory.create(BubbleComponent, "arrowHeight", true) ;
	static private var __ARROW_MARGIN__:Boolean = PropertyFactory.create(BubbleComponent, "arrowMargin", true) ;
	static private var __ARROW_WIDTH__:Boolean = PropertyFactory.create(BubbleComponent, "arrowWidth", true) ;
	static private var __CORNER_RADIUS__:Boolean = PropertyFactory.create(BubbleComponent, "cornerRadius", true) ;
