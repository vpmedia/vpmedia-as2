...
class neo.display.components.shape.RoundedRectangleComponent extends CornerRectangleComponent {
	...
	static private var __CORNER_RADIUS__:Boolean = PropertyFactory.create(RoundedRectangleComponent, "cornerRadius", true) ;
