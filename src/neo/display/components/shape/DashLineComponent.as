...
import neo.display.components.shape.LineComponent;
import neo.util.factory.PropertyFactory;

class neo.display.components.shape.DashLineComponent extends LineComponent {
	...
	static private var __LENGTH__:Boolean = PropertyFactory.create(DashLineComponent, "length", true) ;
	static private var __SPACING__:Boolean = PropertyFactory.create(DashLineComponent, "spacing", true) ;
