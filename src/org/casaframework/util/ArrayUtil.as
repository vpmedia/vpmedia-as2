...
class org.casaframework.util.ArrayUtil {
	...
	*/
	...
	/**
		...
		@usageNote If you are trying to find if an array contains an item or not and don't need to know the total, use {@link #indexOf} instead. <code>item</code> can be any object; <code>Number</code>, <code>String</code>, <code>Object</code>, etc...
	*/
