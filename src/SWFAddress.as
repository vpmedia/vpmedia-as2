...
class SWFAddress {
	...
	private static function _initialize ():Void {
		...
		if (_availability) {
			ExternalInterface.addCallback ('getSWFAddressValue', SWFAddress, function ():String {
				return this._value;
			});
			ExternalInterface.addCallback ('setSWFAddressValue', SWFAddress, SWFAddress.setValue);
		}
	}
	public static function getTitle ():String {
		var title:String = (_availability) ? String (ExternalInterface.call ('SWFAddress.getTitle')) : '';
	...
	public static function getStatus ():String {
		var status:String = (_availability) ? String (ExternalInterface.call ('SWFAddress.getStatus')) : '';
