...
import test_framework.env.event.impulse.FrameImpulse;
 ...
 */
class  test_framework.app.exec.Timeout extends AbstractProcess implements ForEachExecutable {
