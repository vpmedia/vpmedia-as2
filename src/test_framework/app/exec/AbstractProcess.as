...
import test_framework.app.exec.AbstractTimeConsumer;
import test_framework.app.exec.Executable;
import test_framework.app.exec.ProcessErrorListener;
import test_framework.app.exec.ProcessFinishListener;
import test_framework.app.exec.ProcessPauseListener;
import test_framework.app.exec.ProcessResumeListener;
import test_framework.app.exec.ProcessStartListener;
import test_framework.app.exec.ProcessUpdateListener;
import test_framework.data.holder.Map;
import test_framework.data.holder.map.HashMap;
import test_framework.env.event.distributor.CompositeEventDistributorControl;
import test_framework.env.except.AbstractOperationException;
import test_framework.env.except.IllegalArgumentException;
import test_framework.util.MethodUtil;
 ...
 */
class test_framework.app.exec.AbstractProcess extends AbstractTimeConsumer
	implements Process,
	 ...
	 * a row like its handled within a {@link app.exec.Batch}.
	 * 
