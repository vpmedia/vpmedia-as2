...
import test_framework.data.holder.map.PrimitiveTypeMap;
import test_framework.env.except.IllegalArgumentException;
import test_framework.test.mock.Behavior;
import test_framework.test.mock.MethodBehavior;
import test_framework.test.mock.MethodBehaviorFactory;
import test_framework.test.mock.MethodCall;
import test_framework.test.mock.support.DefaultMethodBehavior;
 ...
 * @author Simon Wacker
 */
class test_framework.test.mock.support.DefaultBehavior implements Behavior {
