...
import test_framework.env.reflect.InvocationHandler;
import test_framework.env.reflect.ProxyFactory;
import test_framework.env.reflect.ReflectUtil;
import test_framework.env.reflect.TypeProxyFactory;
import test_framework.test.mock.ArgumentsMatcher;
import test_framework.test.mock.Behavior;
...
import test_framework.test.mock.MockControlState;
import test_framework.test.mock.MockControlStateFactory;
import test_framework.test.mock.support.DefaultArgumentsMatcher;
import test_framework.test.mock.support.DefaultBehavior;
import test_framework.test.mock.support.RecordState;
import test_framework.test.mock.support.ReplayState;
import test_framework.test.mock.support.TypeArgumentsMatcher;
 ...
 * @author Simon Wacker
 */
class test_framework.test.mock.MockControl {
	 ...
	 *
	 * <p>The default behavior is an instance of class {@link test.mock.support.DefaultBehaviour}.
	 *
	...
	private function invokeMethod(methodName:String, args:Array) {
		...
		} catch(error:test_framework.test.mock.MethodCallRangeError) {
			error.setType(type);
			throw error;
		}
		return result;
