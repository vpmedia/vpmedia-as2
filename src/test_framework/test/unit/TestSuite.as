...
import test_framework.app.exec.BatchProcess;
import test_framework.app.exec.Process;
import test_framework.data.holder.array.TypedArray;
...
import test_framework.test.unit.TestSuiteResult;
 ...
 * @version 2.0
 * @see test.unit.TestSuiteFactory
 */
class test_framework.test.unit.TestSuite extends BatchProcess implements Test, TestRunner {
