...
import test_framework.app.exec.Call;
import test_framework.app.exec.Executable;
import test_framework.app.exec.Process;
import test_framework.data.holder.Map;
import test_framework.data.holder.map.HashMap;
import test_framework.env.except.IllegalArgumentException;
import test_framework.env.log.LogSupport;
import test_framework.env.overload.Overload;
import test_framework.test.unit.ExecutionInfo;
import test_framework.test.unit.info.AssertAlmostEqualsInfo;
import test_framework.test.unit.info.AssertEmptyInfo;
import test_framework.test.unit.info.AssertEqualsInfo;
import test_framework.test.unit.info.AssertFalseInfo;
import test_framework.test.unit.info.AssertInfinityInfo;
import test_framework.test.unit.info.AssertInstanceOfInfo;
import test_framework.test.unit.info.AssertNotEmptyInfo;
import test_framework.test.unit.info.AssertNotEqualsInfo;
import test_framework.test.unit.info.AssertNotInfinityInfo;
import test_framework.test.unit.info.AssertNotNullInfo;
import test_framework.test.unit.info.AssertNotSameInfo;
import test_framework.test.unit.info.AssertNotThrowsInfo;
import test_framework.test.unit.info.AssertNotUndefinedInfo;
import test_framework.test.unit.info.AssertNullInfo;
import test_framework.test.unit.info.AssertSameInfo;
import test_framework.test.unit.info.AssertThrowsInfo;
import test_framework.test.unit.info.AssertTrueInfo;
import test_framework.test.unit.info.AssertTypeOfInfo;
import test_framework.test.unit.info.AssertUndefinedInfo;
import test_framework.test.unit.info.FailureInfo;
import test_framework.test.unit.LoggerTestListener;
import test_framework.test.unit.Test;
import test_framework.test.unit.TestCaseRunner;
 ...
 * @version 2.0
 * @see test.unit.TestSuite
 * @see test.unit.Test
 * @see test.unit.TestRunner
 */

class test_framework.test.unit.TestCase extends LogSupport implements Test {
	 ...
	 * {@code test.unit.TestSuiteFactory#collectAllTestCases}.
	 * 
	 ...
	 * 
	 * <p>This method compares two variables by {@link util.ObjectUtil#compare}.
	 * 
	 ...
	 * @see util.ObjectUtil#isInstanceOf
	 */
