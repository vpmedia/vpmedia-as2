...
import test_framework.data.type.Integer;
import test_framework.data.type.NumberFormatException;
 ...
 * @see data.type.NaturalNumberIncludingZero
 */
class  test_framework.data.type.NaturalNumber extends Integer {
