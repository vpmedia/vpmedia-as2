...
import test_framework.env.except.UnsupportedOperationException;
 ...
 */
class  test_framework.data.holder.ProtectedIterator  implements Iterator {
	 ...
	 * @throws data.holder.NoSuchElementException if there is
	 * no next element
	 */
