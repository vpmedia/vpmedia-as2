...
import test_framework.data.holder.EmptyDataHolderException;
import test_framework.data.holder.Iterator;
import test_framework.data.holder.Queue;
import test_framework.data.holder.queue.QueueStringifier;
 ...
 * @author Simon Wacker
 */
class  test_framework.data.holder.queue.LinearQueue  implements Queue {
	...
	public function iterator(Void):Iterator {
		return (new ArrayIterator(mData.concat()));
	}
