...
import test_framework.data.holder.array.ArrayIterator;
import test_framework.data.holder.Iterator;
 ...
 */
class  test_framework.data.holder.map.ValueMapIterator implements Iterator {
	 ...
	 * @throws data.holder.NoSuchElementException if there is no next value
	 */
	 ...
	 * 
	 * @throws env.except.IllegalStateException if you try to remove a
