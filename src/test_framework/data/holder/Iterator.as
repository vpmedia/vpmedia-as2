 ...
 */
interface test_framework.data.holder.Iterator  {
	 ...
	 * @throws data.holder.NoSuchElementException if there is no next element
	 */
	 ...
	 * 
	 * @throws env.except.IllegalStateException if you try to remove an element
	 * when none is selected
	 * @throws env.except.UnsupportedOperationException if this method is not
