...
import test_framework.logging.errors.InvalidLevelError;
...
*	@author Ralf Siegel
*/
class test_framework.logging.Level
{
	/**
	...
	*/
	...
	/**
	*	ASSERTION is a message level user for all assertions.
	*/
	public static var ASSERTION:Level = new Level("ASSERTION", 8);

	/**
	*	SEVERE is a message level indicating a serious failure.
	*/
	public static var SEVERE:Level = new Level("SEVERE", 9);
