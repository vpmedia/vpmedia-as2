...
import test_framework.env.overload.OverloadHandler;
 ...
 * @author Simon Wacker
 */
class test_framework.env.overload.SimpleOverloadHandler implements OverloadHandler {
	 ...
	 * {@code Number}, {@code String}, {@code core.BasicClass},
	 * {@code core.BasicInterface} or any other class or interface.
	 *
	 ...
	 * explicit than {@code Object}. The type {@code core.BasicClass} is
	 * also more explicit than {@code Object}. And the type
	 * {@code env.overload.SimpleOverloadHandler} is more explicit than
	 * {@code core.BasicClass}. I hope you get the image. As you can see,
