...
import test_framework.env.overload.SameTypeSignatureException;
import test_framework.env.overload.SimpleOverloadHandler;
import test_framework.env.overload.UnknownOverloadHandlerException;
 ...
 * @author Simon Wacker
 */
class test_framework.env.overload.Overload {
	 ...
	 * @throws env.overload.UnknownOverloadHandlerException if no adequate
	 * overload handler could be found
	 * @throws env.overload.SameTypeSignatureException if there exist at
