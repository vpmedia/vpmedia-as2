 ...
 */
class test_framework.env.except.StackTraceElementStringifier implements Stringifier {
	 ...
	 * <pre>data.holder.MyDataHolder.setMaximumLength(Number)</pre>
	 * 
	 * <p>Or this:
	 * <pre>data.holder.MyDataHolder.setMaximumLength(-2)</pre>
	 *
