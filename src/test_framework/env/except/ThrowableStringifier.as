 ...
 * @author Simon Wacker
 */
class test_framework.env.except.ThrowableStringifier implements Stringifier {
	 ...
	 * <pre>
	 *   data.holder.IllegalLengthException: The argument length '-2' is not allowed to be negative.
	 *     at data.holder.MyDataHolder.setMaximumLength(Number)
	 *   Caused by: data.math.IllegalNumberException: The argument number '-2' is not allowed in a range from 0 to ∞.
	 *     at data.math.Range.setNumber(Number)
	 * </pre>
	 *
