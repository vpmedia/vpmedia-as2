...
import test_framework.env.log.logger.AscbLogger;
 ...
 *
 * @author Simon Wacker
 * @see env.log.logger.AscbLogger
 */
class test_framework.env.log.repository.AscbLoggerRepository implements LoggerRepository {
