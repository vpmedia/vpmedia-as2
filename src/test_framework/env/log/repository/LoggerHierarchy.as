...
import test_framework.env.except.IllegalStateException;
...
import test_framework.env.log.logger.RootLogger;
import test_framework.env.log.logger.SimpleHierarchicalLogger;
import test_framework.env.log.LoggerRepository;
import test_framework.env.log.repository.ConfigurableHierarchicalLoggerFactory;
 ...
 *   var myLogger:Logger = LogManager.getLogger("mypackage.MyClass");
 ...
 * @author Simon Wacker
 */
class test_framework.env.log.repository.LoggerHierarchy implements LoggerRepository {
	 ...
	 * example {@code core.BasicClass}. In case no logger instance has been
