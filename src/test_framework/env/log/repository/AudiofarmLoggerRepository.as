...
import test_framework.env.log.logger.AudiofarmLogger;
 ...
 *
 * @author Simon Wacker
 * @see env.log.logger.AudiofarmLogger
 */
class test_framework.env.log.repository.AudiofarmLoggerRepository implements LoggerRepository {
