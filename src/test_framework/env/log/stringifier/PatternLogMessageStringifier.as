...
import test_framework.util.DateFormatter;
 ...
 * @author Simon Wacker
 */
class test_framework.env.log.stringifier.PatternLogMessageStringifier implements Stringifier {
