...
import test_framework.env.log.LogConfigurationParser;
import test_framework.env.log.LogManager;
import test_framework.env.log.parser.LogConfigurationParseException;
import test_framework.env.reflect.ClassNotFoundException;
import test_framework.env.reflect.NoSuchMethodException;
 ...
 * bean classes:
 * <code>&lt;register name="logger" class="env.log.logger.SimpleHierarchicalLogger"/&gt;</code>
 * 
 * <p>or to specify the class-attribute in beans:
 * <code>&lt;logger class="env.log.logger.TraceLogger"/&gt;</code>
 * 
 ...
 * 
 * <code>
 *   &lt;handler class="env.log.handler.TraceHandler"&gt;
 *     &lt;constructor-arg class="env.log.stringifier.SimpleLogMessageStringifier"/&gt;
 *   &lt;/handler&gt;
 * </code>
 * 
 ...
 * <code>
 *   &lt;handler class="env.log.handler.TraceHandler"&gt;
 *     &lt;constructor-arg class="env.log.stringifier.PatternLogMessageStringifier"&gt;
 ...
 * <code>
 *   &lt;logging&gt;
 *     &lt;register name="logger" class="env.log.logger.SimpleHierarchicalLogger"/&gt;
 *     &lt;loggerRepository class="env.log.repository.LoggerHierarchy"&gt;
 *       &lt;logger name="com.simonwacker" level="INFO"&gt;
 *         &lt;handler class="env.log.handler.DebugItHandler"/&gt;
 *         &lt;handler class="env.log.handler.TraceHandler"/&gt;
 *       &lt;/logger&gt;
 *       &lt;logger name="com.simonwacker.MyClass" level="ERROR"&gt;
 *         &lt;handler class="env.log.handler.SosHandler"/&gt;
 *       &lt;/logger&gt;
 *     &lt;/repository&gt;
 *   &lt;/logging&gt;
 * </code>
 ...
 * <code>
 *   &lt;logging&gt;
 *     &lt;logger level="INFO" class="env.log.logger.TraceLogger"/&gt;
 *   &lt;/logging&gt;
 * </code>
 * 
 * @author Simon Wacker
 */
class test_framework.env.log.parser.XmlLogConfigurationParser implements LogConfigurationParser {
