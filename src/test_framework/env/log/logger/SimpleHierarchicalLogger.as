...
import test_framework.env.log.ConfigurableHierarchicalLogger;
import test_framework.env.log.ConfigurableLogger;
import test_framework.env.log.HierarchicalLogger;
import test_framework.env.log.logger.AbstractLogger;
 ...
 * at the {@code env.log.handler} package for these. This logger does
 ...
 *
 * @author Simon Wacker
 * @see env.log.repository.LoggerHierarchy
 */
class test_framework.env.log.logger.SimpleHierarchicalLogger extends AbstractLogger implements ConfigurableLogger, ConfigurableHierarchicalLogger {
	 ...
	 * periods. The name could for example be {@code "core.BasicClass"}.
	 *
	 ...
	 * @see env.log.level.AbstractLogLevel#DEBUG
	 * @see #debug
	 */
	 ...
	 * @see env.log.level.AbstractLogLevel#INFO
	 * @see #info
	 */
	 ...
	 * @see env.log.level.AbstractLogLevel#WARNING
	 * @see #warning
	 */
	 ...
	 * @see env.log.level.AbstractLogLevel#ERROR
	 * @see #error
	 */
	 ...
	 * @see env.log.level.AbstractLogLevel#FATAL
	 * @see #fatal
	 */
