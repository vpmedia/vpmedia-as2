...
import test_framework.env.reflect.algorithm.ClassAlgorithm;
import test_framework.env.reflect.algorithm.MethodAlgorithm;
import test_framework.env.reflect.algorithm.PropertyAlgorithm;
import test_framework.env.reflect.ClassNotFoundException;
import test_framework.env.reflect.ConstructorInfo;
import test_framework.env.reflect.MethodInfo;
import test_framework.env.reflect.PackageInfo;
import test_framework.env.reflect.PropertyInfo;
import test_framework.env.reflect.ReflectConfig;
import test_framework.env.reflect.TypeInfo;
import test_framework.env.reflect.TypeMemberFilter;
 ...
 * @author Simon Wacker
 */
class test_framework.env.reflect.ClassInfo implements TypeInfo {
	 ...
	 * 'core.BasicClass' is 'core'. In this example this method
	 ...
	 *
	 * <p>The package of the class {@code core.BasicClass} is
	 * {@code core}.
	 *
