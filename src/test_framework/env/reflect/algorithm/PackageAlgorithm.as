...
import test_framework.env.reflect.Cache;
import test_framework.env.reflect.PackageInfo;
import test_framework.env.reflect.PackageNotFoundException;
 ...
 *   var packageInfoByPackage:PackageInfo = packageAlgorithm.execute(core);
 * </code>
 *
 * <p>It is also possible to retrieve a package info by name.
 *
 * <code>
 *   packageInfoByName:PackageInfo = packageAlgorithm.executeByName("core");
 * </code>
 *
 ...
 * @author Simon Wacker
 */
class test_framework.env.reflect.algorithm.PackageAlgorithm {
	 ...
	 * path as well as its name. For example 'core'.
	 *
