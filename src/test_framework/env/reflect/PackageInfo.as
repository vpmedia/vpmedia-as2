...
import test_framework.env.reflect.algorithm.PackageAlgorithm;
import test_framework.env.reflect.algorithm.PackageMemberAlgorithm;
import test_framework.env.reflect.ClassInfo;
import test_framework.env.reflect.PackageMemberFilter;
import test_framework.env.reflect.PackageMemberInfo;
 ...
 * 
 * <code>
 *   var packageInfo:PackageInfo = PackageInfo.forPackage(core);
 ...
 * @author Simon Wacker
 */
class test_framework.env.reflect.PackageInfo implements PackageMemberInfo {
	 ...
	 * represented for example the {@code core} package the returned
	 ...
	 * of. The parent of the package {@code core} is {@code org.as2lib}.
	 *
