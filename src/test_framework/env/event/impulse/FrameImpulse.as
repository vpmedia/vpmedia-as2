...
import test_framework.env.event.impulse.AbstractImpulse;
import test_framework.env.event.impulse.FrameImpulseListener;
import test_framework.env.event.impulse.Impulse;
import test_framework.env.except.FatalException;
import test_framework.env.except.IllegalArgumentException;
import test_framework.env.reflect.ReflectUtil;
import test_framework.util.ArrayUtil;
 ...
 * Example:
 * <code>
 *   import app.exec.Executable;
 *   import env.event.impulse.FrameImpulseListener;
 *   import app.exec.FrameImpulse;
 *   
 ...
 * @version 1.5
 */
class test_framework.env.event.impulse.FrameImpulse extends AbstractImpulse implements Impulse {
	 ...
	 * <p>Example:
	 * <code>
	 *   import env.event.impulse.Impulse;
	 *   import env.event.impulse.FrameImpulse;
	 *  
	...
	public function addListener(listener):Void {
		...
		} catch(e:test_framework.env.except .IllegalArgumentException) {
			added = false;
		}
