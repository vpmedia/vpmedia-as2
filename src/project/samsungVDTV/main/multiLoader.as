...
class project.samsungVDTV.main.multiLoader extends EventDispatcher
{
	...
	private var imgLoadMc:String;
	private var attachTarget:String;
	private var loadUrl:Array;
	private var listArry:Array;
	...
	*/
	...
	public function multiLoader(container:MovieClip , imgLoadMc:String , attachTarget:String , loadUrl:Array , listArry:Array )
	{
		this.container = container;
		this.loadUrl = loadUrl;
		this.listArry = listArry;
		this.imgLoadMc = imgLoadMc;
	...
	private function loadStart()
	{
		for (var i=1;i<=totalLoadingCount;i++) {
			var ddk:MovieClip = container.attachMovie( attachTarget , "image" + i, i + 10 );
			returnArray.push(ddk);
			loader.loadClip(loadUrl[i-1] , ddk[imgLoadMc] );
		}
	}
	...
	private function onLoadInit(mc:MovieClip)
	{
		...
		if (loadingCount==totalLoadingCount) {
			...
			dispatchEvent({type:multiLoader.LOAD_COMPLETE , returnArray:returnArray , listArray:listArry , mc:container});
		}
	}
}
