//Source file: D:\\Wersling WAS Framework\\javacode\\was\\util\\Collection.java

//package was.util;

import net.manaca.lang.Iterable;
 ...
 * @version 1.0
 */
interface net.manaca.data.Collection extends Iterable 
{
	
	/**
	 * 确保此 collection 包含指定的元素（可选操作）。如果此 collection 由于此方法的调用而发生改变，则返回 true。
	...
	/**
	 * 从此 collection 中移除指定元素的单个实例，如果存在的话（可选操作）。更正式地说，
	...
	/**
	 * 仅保留此 collection 中那些也包含在指定 collection 的元素（可选操作）。换句话说，
