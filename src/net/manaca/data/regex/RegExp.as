...
//---------------------------------------------------------------------------
class net.manaca.data.regex.RegExp {
	private var className : String = "net.manaca.data.regex.RegExp";
	...
	function RegExp() {
		if (arguments[0] == null) {
			...
			const = "net.manaca.data.regex.RegExp";
	...
	public static function setStringMethods():Boolean {
		...
		String.prototype.match = function() {
			...
			if (arguments[0].const != "net.manaca.data.regex.RegExp") {
				return null;
			}
			var re = arguments[0];
			var s = this.valueOf();
		...
		String.prototype.split = function() {
			if (typeof (arguments[0]) == "object" && arguments[0].const == "net.manaca.data.regex.RegExp") {
				var re = arguments[0];
				...
				while (rc<lm && re.test(s)) {
					//trace(re._xi + " " + ix + " " + net.manaca.data.regex.RegExp.lastMatch);
					if (re._xi != ix) {
