 ...
 */
class net.manaca.globalization.festival.FestivalInfoForCn {
	/**
	 * 获取中文的所有节日列表
	 */
	public static function getList():Array{
		var a:Array = new Array();
		a[0] = ({Name:"常见国际性节日",Data:INT_FTV_FAR});
		a[1] = ({Name:"所有国际性节日",Data:ESP_FTV,Week:WEEK_FTV});
		a[2] = ({Name:"中国农历节日",Data:CHINA_FTV_FOR_CHINA_FESTIVAL});
		a[3] = ({Name:"中国公历节日",Data:CHINA_FTV_All});
		return a;
	}
	/** 常见的国际性节日 */
	...
	/**
	 * 用于将 "1225*圣诞节" 格式数据转为数据格式的方法
	 */
	public static function getFestivalList(Arr):Void{
		for(var i in Arr){
			var s:String = new String(Arr[i]);
			var $1:String = String(s.slice(0,4));
			var $3 = s.slice(4,5);
			if ($3 == "*") {
				$3 = "true";
			}else{
			...
			var $4:String = s.slice(5);
		}
	}
	public static function trac(Arr,type):Void{
