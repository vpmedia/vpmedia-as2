 ...
 * @author iiley
 */
class net.manaca.ui.awt.AdvancedPen extends Pen {
	...
	public function AdvancedPen(color : ASColor, thickness : Number, pixelHinting:Boolean, noScale:String, capsStyle:String, jointStyle:String, miterLimit:Number) {
