//Source file: D:\\Wersling WAS Framework\\javacode\\was\\util\\event\\EventDispatcher.java

//package was.util.event;
 ...
 * @version 1.0
 */
class net.manaca.lang.event.EventDispatcher 
{
	...
	static private function _removeEventListener(queue:Object, event:String, handler):Void
	{
		if (queue != undefined)
		{
	...
	*/
	static function initialize(object:Object):Void
	{
		...
		//object.addEventListenerOfEven = _fEventDispatcher.addEventListenerOfEven;
