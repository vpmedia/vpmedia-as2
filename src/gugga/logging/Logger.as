...
class gugga.logging.Logger
{
	...
	*/
	...
	public static function getLoggerFor(aObject:Object):Logger
	{
		var logger : Logger = Logger(aObject[OBJECT_DEFAULT_LOGGER_VAR_NAME]);
	...
	public static function logFinest(message:String, aContextObject:Object):Void
	{
		Logger.logMessage(Level.FINEST, message, aContextObject);
	}

	public static function logFiner(message:String, aContextObject:Object):Void
	{
		Logger.logMessage(Level.FINER, message, aContextObject);
	}

	public static function logFine(message:String, aContextObject:Object):Void
	{
		Logger.logMessage(Level.FINE, message, aContextObject);
	}

	public static function logInfo(message:String, aContextObject:Object):Void
	{
		Logger.logMessage(Level.INFO, message, aContextObject);
	}

	public static function logWarning(message:String, aContextObject:Object):Void
	{
		Logger.logMessage(Level.WARNING, message, aContextObject);
	}
		
	public static function logSevere(message:String, aContextObject:Object):Void
	{
		Logger.logMessage(Level.SEVERE, message, aContextObject);
	}
	
	public static function logMessage(level:Level, message:String, aContextObject:Object):Void
	{
