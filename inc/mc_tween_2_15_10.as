...
=              oct 01 (1.12.8) - minor fix (misspell) on stopTween(), thanks kim
...
=                                "backwardCallbackTweening" to make it compatible
=         2004 feb 10 (2.13.9) - better time control for synch start
=         2004 feb 10 (2.14.9) - made it possible to tween the same property
=                                several times (not direct overwritting) - ie,
=                                complex animations are now possible with
=                                sequence tweenings
=        2004 feb 11 (2.14.10) - optimizations for speed
=        2004 feb 11 (2.15.10) - added lockTween() and unlockTween()
=
=------------------------------------------------------------------------------
...
MovieClip.prototype.stopTween = function(props) {
  ...
  case "object": // several properties. example: ["_alpha", "_rotation"]
    ...
    this.$_tweenCount = tweenPropList.length;
    break;
